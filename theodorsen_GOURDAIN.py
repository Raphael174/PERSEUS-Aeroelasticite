# -*- coding: utf-8 -*-
"""
Created on Wed May  4 19:47:02 2022
...
#        CZ= -coeff*VecTeta[0]
        # Quasi-steady
#        CZ= -coeff*(VecTeta[0]+VecH[1]/U_inf)
        #Theodorsen
        CZ = -PI*( b/U_inf*VecTeta[1] + b/U_inf**2*VecH[2] - (a*b**2)/U_inf**2*VecTeta[2] ) \
                                        -coeff*computeCk(U_inf,chord)*(VecTeta[0] + VecH[1]/U_inf + ( (0.5-a)*(b*VecTeta[1])/U_inf) )
        #------------------
...
def computeMoment(q,U_inf,Surf,chord,VecH,VecTeta):
        ...
        b = 0.5*chord
        a=2.8e-3/b
        coeff = ((b-2.8e-3)/chord-0.25)*2*PI
#        coeff = 0.91
#        Stationnary
#        CM=1
        # Pure steady model
        #a=0 ie xCG=0 ie coef=2pi/4
#        CM=2.*PI*VecTeta[0]/4.
        # Quasi-steady
#        CM=2.*PI*(VecTeta[0]+VecH[1]/U_inf)/4.
